...
(deftest test-except-soccer
  "test abnormal case"
  (is (thrown? AssertionError (max-points "string", 1)))
  (is (thrown? AssertionError (max-points 1, "string")))
  (is (thrown? AssertionError (max-points 1, 1)))
  )
